...
export class UtilityServiceService {
  ...
  refreshActiveOrdersCount:Subject<string>;
  refreshDistributorActiveOrdersCount:Subject<string>;
  ...
  constructor() { 
    ...
    this.refreshActiveOrdersCount = new Subject<string>();
    this.refreshDistributorActiveOrdersCount = new Subject<string>();
